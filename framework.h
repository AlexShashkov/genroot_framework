...
switch (P)
  ...
  // More than 4 roots, no general formula.
    {
        // TODO: convert some variables and operations to BIGNUM, then cast roots and coefficients to fp_t - 4 Traub team
        ...
        int crnt_idx;
        int generated4 = crnt_idx = generate_polynomial_4(first4_complex_roots, first4_clustered_roots, first4_multiple_roots, max_distance_between_clustered_roots, 
